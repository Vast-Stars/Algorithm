function SONAR = import_SONAR(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   SONAR = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   SONAR = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   SONAR = importfile1('SONAR.csv', 1, 208);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/10/29 16:41:16
